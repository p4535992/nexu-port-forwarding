...
public final class Launcher {
    ...
    public static void main(String[] args) {
        ...
        if(values.contains("--version")) { System.out.println("Nexu Port Forwarding 1.2.1"); return; }
    ...
    private static void sshRuntimeSmokeTest() {
        ...
        try {
            ...
            if(home!=null&&!home.isBlank()) {
                ...
                Files.writeString(dir.resolve("ssh-runtime-ready"),"SSH_RUNTIME_READY 1.2.1\n",StandardCharsets.UTF_8);
            }
            System.out.println("SSH_RUNTIME_READY 1.2.1");
